...
public class Get12Pojo extends HerOkuAppBaseUrl {
    ...
    public void get01Pojo(){
        ...
        BookingDatesPojo bookingDatesPojo = new BookingDatesPojo("2020-09-15", "2020-11-16");
        BookingPojo bookingPojo = new BookingPojo("Sally", "Ericsson", 375, true, bookingDatesPojo, "Breakfast");
